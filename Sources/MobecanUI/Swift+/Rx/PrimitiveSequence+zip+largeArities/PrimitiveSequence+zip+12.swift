...
extension PrimitiveSequenceType where Trait == SingleTrait {
   ...
   */
  public static func zip<E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12>(
    ...
    _ source11: PrimitiveSequence<Trait, E11>,
    _ source12: PrimitiveSequence<Trait, E12>,
    resultSelector: @escaping (E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12) throws -> Element)
  -> PrimitiveSequence<Trait, Element> {
    Single.zip(
      Single<Any>.zip(source1, source2, source3),
      Single<Any>.zip(source4, source5, source6),
      Single<Any>.zip(source7, source8, source9),
      Single<Any>.zip(source10, source11, source12)
    ) {
      try resultSelector(
        $0.0, $0.1, $0.2,
        $1.0, $1.1, $1.2,
...
extension PrimitiveSequenceType where Element == Any, Trait == SingleTrait {
  ...
  public static func zip<E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12>(
    ...
    _ source11: PrimitiveSequence<Trait, E11>,
    _ source12: PrimitiveSequence<Trait, E12>
  ) -> PrimitiveSequence<Trait, (E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12)> {
    Single.zip(
      Single<Any>.zip(source1, source2, source3),
      Single<Any>.zip(source4, source5, source6),
      Single<Any>.zip(source7, source8, source9),
